...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.136 Mobile Safari/537.36')]

def keluar():
    print '\x1b[1;91mClose'
    os.sys.exit()
...
def login():
    ...
    try:
        ...
        menu()
            ...
            print '\x1b[1;92m\n\nLogin Your Account Facebook '
            id = raw_input('\x1b[1;36mUsername \x1b[1;91m:\x1b[1;97m ')
            pwd = getpass.getpass('\x1b[1;36mPassword \x1b[1;91m:\x1b[1;93m ')
            tik()
            try:
...
def menu():
    ...
    print '\x1b[1;37;40m1. Information User      '
    print '\x1b[1;37;40m2. Hack Facebook Acc     '
...
def lain():
    ...
    print '\x1b[1;37;40m6. My Profil'
    print '\x1b[1;37;40m7. Author'
    print
    print '\x1b[1;31;40m0. Kembali'
    print
    pilih_lain()
...
def myprofil():
    ...
    try:
        toket = open('login.txt', 'r').read()
            ...
            login()
                ...
                try:
                    iam = requests.get('https://graph.facebook.com/me?access_token=' + toket)
                    a = json.loads(iam.text)
                    nama = a['name']
                    id = a['id']
                    email = a['email']
                    number = a['number']
                    ...
                    sekolah = a['school']
                        ...
                        os.system('clear')
                        print '\x1b[1;91m[!] \x1b[1;93mYour Account Has Been Checkpoint'
                        os.system('rm -rf login.txt')
                        time.sleep(1)
                        login()
                        except requests.exceptions.ConnectionError:
    ...
    print '\x1b[1;97mName \x1b[1;91m: \x1b[1;92m' +nama
    print '\x1b[1;97mID \x1b[1;91m: \x1b[1;93m' +id
    print '\x1b[1;97mEmail \x1b[1;91m: \x1b[1;94m' +email
    print '\x1b[1;97mNumber \x1b[1;91m: \x1b[1;94m' +number
    print '\x1b[1;97mPassword \x1b[1;91m: \x1b[1;94m ' +pwd
    print '\x1b[1;97mBirthday \x1b[1;91m: \x1b[1;96m' +birthday
    print '\x1b[1;97mLocation \x1b[1;91m: \x1b[1;97m' +addres
    print '\x1b[1;97mSchool \x1b[1;91m: \x1b[1;90m' +sekolah
...
def author():
    ...
    print thanks
    print message
    print '\n\n\x1b[1;97m Please Wait....'
    time.sleep(8)
    os.system('clear')
    print '\n\n\x1b[1;93m         [\x1b[1;97m\x1b[1;93mVisit Me In\x1b[1;97m] '
    print '\n\x1b[1;97m1\x1b[0;91m. \x1b[1;90mGithub      '
    print '\x1b[1;97m2\x1b[0;91m. \x1b[1;91mYoutube     '
    print '\x1b[1;97m3\x1b[0;91m. \x1b[1;96mFacebook    '
    print '\x1b[1;97m4\x1b[0;91m. \x1b[1;95mInstagram   '
    print '\x1b[1;97m5\x1b[0;91m. \x1b[1;92mWhatsapp    '
    print '\n\x1b[1;97m0\x1b[0;91m. \x1b[1;97mBack '

             ngauthor()
         def ngauthor():
            nginfor = raw_input('Select\>> ')
               if nginfor == '':
                   print '\x1b[1;91mCannot Empty'
                   ngauthor()
                   else:
                       if nginfor == '1':
                           os.system('xdg-open https://github.com/Cyber-ID')
                           infor()
                            if nginfor == '2'
                                os.system('xdg-open https://www.youtube.com/channel/UClhST1WdWRHsum_XvWmCI8A')
                                infor()
                                else:
                                    if nginfor == '3'
                                        os.system('xdg-open https://www.facebook.com/officialCyberID')
                                        infor()
                                        else:
                                            if nginfor == '4'
                                               os.system('xdg-open https://www.instagram.com/cy_ber.id')
                                               infor()
                                               else:
                                                   if nginfor == '5'
                                                      os.system('xdg-open https://api.whatsapp.com/send?phone=085839211030')
                                                      infor()
                                                      else:
                                                          if nginfor == '0'
                                                             lain()
                                                             else:
                                                                 print '\x1b[1;91mOops, Sorry You Are Noob'
                                                                 time.sleep(2)
                                                                 author()
